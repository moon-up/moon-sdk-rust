...
pub async fn resolve(configuration: &configuration::Configuration, authorization: &str, ens_resolve_input: crate::models::EnsResolveInput) -> Result<crate::models::AccountControllerResponse, Error<ResolveError>> {
    ...
    let local_var_uri_str = format!("{}/ens/resolve", local_var_configuration.base_path);
    ...
    local_var_req_builder = local_var_req_builder.json(&ens_resolve_input);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ResolveError> = serde_json::from_str(&local_var_content).ok();
